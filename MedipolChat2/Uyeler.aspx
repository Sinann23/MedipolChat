<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Uyeler.aspx.cs" Inherits="MedipolChat2.Uyeler" %>
...
<body >
    <form id="form1" method="get" runat="server">
        <div class="AnasayfaGenel">
            ...
            <div class="odalar">
                <div class="odaAdi"><span class="odaisim">ÜYELER (<asp:Label ID="Label2" runat="server" Text="Label">?</asp:Label>)</span></div>
                <hr class="cizgi" />
                  <asp:Label ID="Label1" runat="server" Text="Label">Snnklc</asp:Label> <asp:Button ID="Button1" runat="server" Text="Kullanıcıyı Banla" /> <br /> 
